...
class AccessControlListManager(models.Manager):
    ...
    def restrict_queryset(self, permission, queryset, user):
        # /opt/mayan-edms/lib/python3.7/site-packages/mayan/apps/acls/managers.py
        ...
        if queryset:
            try:
                ...
                print("User got permission? ", permission.stored_permission.user_has_this(user=user))
        ...
        if str(queryset) == "documents.DocumentPage.valid":
            return queryset
